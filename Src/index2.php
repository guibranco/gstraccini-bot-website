...
<html lang="en">
  ...
  <body>
    <header>
      <img
        src="https://raw.githubusercontent.com/guibranco/gstraccini-bot-website/main/Src/logo.png"
      ...
      <p>🤖 <img
          ...
          alt="GitHub Octocat" class="octocat"> A GitHub bot that automates
        tasks, manages pull requests, issues, comments, and commits.</p>
      <img src="https://bot.straccini.com/gstraccini-bot.png"
        alt="GStraccini-bot image">
      <div class="badges">
        <a
          href="https://github.com/guibranco/gstraccini-bot/actions/workflows/deploy.yml">
          <img
            src="https://github.com/guibranco/gstraccini-bot/actions/workflows/deploy.yml/badge.svg"
            alt="Deploy via FTP Badge">
        </a>
        <a
          href="https://github.com/guibranco/gstraccini-bot/actions/workflows/php-lint.yml">
          <img
            src="https://github.com/guibranco/gstraccini-bot/actions/workflows/php-lint.yml/badge.svg"
            alt="PHP Linting Badge">
        </a>
        <a
          href="https://github.com/guibranco/gstraccini-bot/actions/workflows/json-yaml-lint.yml">
          <img
            src="https://github.com/guibranco/gstraccini-bot/actions/workflows/json-yaml-lint.yml/badge.svg"
            alt="JSON/YAML Validation Badge">
        </a>
        <a
          href="https://github.com/guibranco/gstraccini-bot/actions/workflows/shell-cheker.yml">
          <img
            src="https://github.com/guibranco/gstraccini-bot/actions/workflows/shell-cheker.yml/badge.svg"
    ...
    <section>
      ...
      <p>You can retrieve an updated list of available commands by commenting
        <code>@gstraccini help</code> on a pull request. </p>
    </section>
    <section>
    ...
    <section>
      ...
      <ul>
        ...
        <li><a href="https://github.com/guibranco/gstraccini-bot-service">Service</a> – The main worker that processes tasks.</li>
        <li><a href="https://github.com/guibranco/gstraccini-bot-website">Website</a> – Provides the bot's landing page and dashboard.</li>
    ...
    <section>
      ...
      <ul>
        <li><img
            src="https://healthchecks.io/b/3/82d0dec5-3ec1-41cc-8a35-ef1da42899e5.svg"
            alt="GStraccini Bot - Branches"></li>
        <li><img
            src="https://healthchecks.io/b/3/31b38cb0-f8bd-42b1-b662-d5905b22cd94.svg"
            alt="GStraccini Bot - Comments"></li>
        <li><img
            src="https://healthchecks.io/b/3/05666a6b-d35f-4cb8-abc8-25584cc9029b.svg"
            alt="GStraccini Bot - Issues"></li>
        <li><img
            src="https://healthchecks.io/b/3/05c48393-c700-45b4-880f-59cb7b9b9f25.svg"
            alt="GStraccini Bot - Pull Requests"></li>
        <li><img
            src="https://healthchecks.io/b/3/1e8724fa-8361-47d7-a4f6-901e8d4ff265.svg"
            alt="GStraccini Bot - Pushes"></li>
        <li><img
            src="https://healthchecks.io/b/3/4ef0ee6c-38f8-4c79-b9f7-049438bd39a9.svg"
            alt="GStraccini Bot - Repositories"></li>
        <li><img
            src="https://healthchecks.io/b/3/8303206b-2f4c-4300-ac64-5e9cd342c164.svg"
