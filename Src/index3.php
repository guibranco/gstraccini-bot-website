...
<header>
    <img src="https://raw.githubusercontent.com/guibranco/gstraccini-bot-website/main/Src/logo.png" alt="GStraccini-bot Logo">
...
<section>
    <h2>About the Bot</h2>
    <p>🤖 <img src="https://github.githubassets.com/images/icons/emoji/octocat.png" alt="GitHub Octocat" class="octocat"> <strong>GStraccini-bot</strong> automates repository tasks like managing pull requests, issues, comments, and commits. This allows you to focus on solving real problems.</p>
    ...
    <div class="badges">
        <a href="https://github.com/guibranco/gstraccini-bot/actions/workflows/deploy.yml">
            <img src="https://github.com/guibranco/gstraccini-bot/actions/workflows/deploy.yml/badge.svg" alt="Deploy Badge">
        </a>
    ...
    <section>
        <h2>How It Works</h2>
        <p>The bot works by using various components to manage your repository:</p>
        <ul>
    ...
    <section>
        ...
        <ul>
            ...
            <li><a href="https://bot.straccini.com">Bot Dashboard</a></li>
        </ul>
    </section>
    <section>
      <ul>
...
<footer>
    <p>© 2024 GStraccini-bot | <a href="https://github.com/guibranco/gstraccini-bot">GitHub Repository</a></p>
</footer>
