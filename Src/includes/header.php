<header class="navbar navbar-dark bg-primary">
    <div class="container-fluid">
        <a href="https://bot.straccini.com/dashboard.php"><img src="/images/logo-white.png" alt="Bot Logo"
                class="me-2"></a>
        ...
        <div class="d-flex align-items-center">
            <span id="themeSwitcher" class="theme-switcher text-white me-3">
                <i class="fas fa-sun"></i>
            </span>
            <div class="dropdown me-3">
                <a href="#" id="notificationsDropdown" class="position-relative" data-bs-toggle="dropdown"
                    aria-expanded="false">
            ...
            <div class="dropdown me-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                    <li><a class="dropdown-item" href="dashboard.php"><i class="fas fa-tachometer-alt me-2"></i>
                            Dashboard</a></li>
